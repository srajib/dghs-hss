								...
								{   $i++;
								 ...
								 $answers = mysql_query("SELECT * FROM hss_answers where answer_q_id=$qid");
									...
									//print_r(questionReturn($qid));
									 ...
									 $url1='images/';
									$path1 =$url1.'q'.$qid.'_'.$user_email.'_'.$answer_storage_month_year.'_1.jpg';
									$imgurl_check1 = $path1;
									if (!is_array(@getimagesize($imgurl_check1)))
										  { ?><img src="images/no.jpg" width="50" height="50">&nbsp;
									     <?php }else{ ?><img src="<?php echo $imgurl_check1;?>" width="50" height="50">&nbsp;<?php }  
								 	echo '';
									$path2 =$url1.'q'.$qid.'_'.$user_email.'_'.$answer_storage_month_year.'_2.jpg';
									$imgurl_check2 = $path2;
								    if (!is_array(@getimagesize($imgurl_check2)))
										  { ?><img src="images/no.jpg" width="50" height="50">&nbsp;
									     <?php }else{ ?><img src="<?php echo $imgurl_check2;?>" width="50" height="50">&nbsp;<?php }  
								 	echo '';
									
									$path3 =$url1.'q'.$qid.'_'.$user_email.'_'.$answer_storage_month_year.'_3.jpg';
									$imgurl_check3 = $path3;
								    if (!is_array(@getimagesize($imgurl_check3)))
										  { ?><img src="images/no.jpg" width="50" height="50">
									     <?php }else{ ?><img src="<?php echo $imgurl_check3;?>" width="50" height="50"><?php }  
								 	echo '</div>';
