		...
		<div class="row">
			...
			<div class="span6">
				...
				<div class="widget widget-accordion">
				 ...
				 <h3>  <a href="add_question_type.php"> Add Answer</a></h3>
				...
				<?php	
				  $date=date('d-m-Y');
                   if($submit)	{			
					...
					//mysql_close($con);
					 $answer=mysql_query("SELECT * FROM hss_answers,hss_questions where hss_answers.answer_q_id=hss_questions.question_id");
						 
						   while($question_types = mysql_fetch_array($answer))
						   {
						    //echo "<pre>";
							//print_r($question_types);
							echo $question_types['question_desc'].'<br>';	 
           					echo $question_types['answer_ans1'].'&nbsp;&nbsp;&nbsp;';	  
							echo $question_types['answer_ans2'].'&nbsp;&nbsp;&nbsp;';	
							echo $question_types['answer_ans3'].'<br>';								
       						}
					?>
				   </div>
				              </div>
